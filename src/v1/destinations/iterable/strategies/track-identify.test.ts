...
describe('TrackIdentifyStrategy', () => {
  ...
  describe('handleSuccess', () => {
    it('should handle successful response with events', () => {
      ...
      const result = strategy.handleSuccess(mockInput);
    ...
    it('should handle successful response with users', () => {
      const mockInput: IterableBulkProxyInput = {
        destinationResponse: {
          status: 200,
          response: {
    ...
    it('should handle successful response with partial failures', () => {
      const mockInput: IterableBulkProxyInput = {
        destinationResponse: {
          status: 200,
          response: {
    ...
    it('should handle successful response with no events or users', () => {
      const mockInput: IterableBulkProxyInput = {
        destinationResponse: {
          status: 200,
          response: {
    ...
    it('should handle successful response with empty events array', () => {
      const mockInput: IterableBulkProxyInput = {
        destinationResponse: {
          status: 200,
          response: {
    ...
    it('should handle successful response with complex error scenarios', () => {
      const mockInput: IterableBulkProxyInput = {
        destinationResponse: {
          status: 200,
          response: {
